...
abstract class BaseFragment: SwipeBackFragment(){
    ...
    private fun setTitle(isBack : Boolean, title : String, rightTitle : String?, rightImg : Int){
        ...
        val topRight = rootView?.findViewById<RoundTextView>(R.id.top_right)
     ...
     * 是否有更多
     */
    protected fun setRefreshLayoutMode(listSize: Int, totalRow: Int) {
