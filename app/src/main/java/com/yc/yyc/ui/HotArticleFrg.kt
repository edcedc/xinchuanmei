...
import com.yc.yyc.R
import com.yc.yyc.adapter.HotArticleAdapter
 ...
 *  推荐
 */
class HotArticleFrg : BaseFragment(), RecommendContract.View{

    val mPresenter by lazy { RecommendPresenter() }

    val adapter by lazy { HotArticleAdapter(activity!!, this, listBean) }
