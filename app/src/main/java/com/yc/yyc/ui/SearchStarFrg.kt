 ...
 * Time: 16:28
 */
class SearchStarFrg : BaseFragment(), SearchContract.View{
    ...
    val adapter by lazy { activity?.let { ThreeAdapter(it, this, listBean, 0) } }
    ...
    override fun initView(rootView: View) {
        ...
        refreshLayout?.setOnRefreshLoadMoreListener(object : OnRefreshLoadMoreListener {
            override fun onRefresh(refreshLayout: RefreshLayout) {
                pagerNumber = 1
                mPresenter.onRequestStar(pagerNumber, searchContent)
            }
