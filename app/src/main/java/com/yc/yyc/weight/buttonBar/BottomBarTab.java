...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.y2 : R.mipmap.y1);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.y4 : R.mipmap.y3);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.y6 : R.mipmap.y5);
                break;
            case 3:
                mIcon.setImageResource(selected? R.mipmap.y8 : R.mipmap.y7);
                break;
            case 4:
                mIcon.setImageResource(selected? R.mipmap.y11 : R.mipmap.y9);
                break;
        }
        if (selected) {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.red_EF402C));
            mTvTitle.setTextColor(Color.parseColor("#E0582B"));
        } else {
